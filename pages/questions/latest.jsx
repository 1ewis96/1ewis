...
export default function LatestQuestionsPage() {
  ...
  useEffect(() => {
    async function fetchQuestions() {
      try {
        ...
        let url = `https://api.1ewis.com/questions/latest?limit=${limit}`;
        if (token) {
          url += `&token=${token}`;
        }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-black via-gray-900 to-black text-white">
      <Head>
        <title>Latest Crypto Questions | 1ewis.com</title>
        <meta name="description" content="Browse the latest cryptocurrency questions and answers from the 1ewis.com community." />
        <meta name="keywords" content="crypto questions, cryptocurrency answers, latest questions, bitcoin help, crypto community" />
        <link rel="canonical" href="https://1ewis.com/questions/latest" />
      </Head>
      ...
      <main className="pt-32 pb-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <div className="mb-8">
          ...
          <p className="text-gray-300 mt-2">
            Browse the most recent questions from the crypto community
          </p>
        </div>
              ...
              <ul className="divide-y divide-gray-700">
                {questions.map((question) => (
                  <li key={question.PK} className="hover:bg-gray-800/50 transition-colors">
                    <Link href={`/question/${question.PK}`} className="block">
